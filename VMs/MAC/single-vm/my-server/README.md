...
1. Edit the Vagrant file to update the Hardware settings as per your requirements.  
   Example:-  
    ...
    c. To change the disk size to 20GB.Make:-  **DISK_SIZE = "20"**  
    d. To change to number of additional disks to 2. Make:-  **ADDITIONAL_DISK_COUNT = 2**  
    e. To change the each additional disk size to 3GB. Make:-  **ADDITIONAL_DISK_SIZE = "3"**  
    f. To change the private vm network IP address to. Make:-  **NETWORK_IP = 192.168.1.5**"   
